# Chapter 7: Creating a Vector Search Service
...
This branch implements the vector search service. In this chapter, you will:
- Build a service to query articles using vector embeddings and similarity search.
- Prepare the backend to respond to vector search queries.
- Lay the groundwork for integrating the search service into the application.
...
- `services/search/` - Vector search logic (new in this chapter)
